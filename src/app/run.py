...
def make_app(
    *di_providers: Provider,
    ...
    # Attach container to FastAPI and integrate with DI
    setup_dishka(container=async_ioc_container, app=app)
    app.state.dishka_container = async_ioc_container

    configure_app(app=app, root_router=root_router)

    log.info(">>> registering startup/shutdown handlers")
